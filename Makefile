...
allLarge:
	cd src && g++ -std=c++17 -o main main.cpp InputFile.cpp DynamicProgramming.cpp RandomizedGreedy.cpp VND.cpp KPSolution.cpp && ./main test-cases/large_scale/knapPI_3_10000_1000_1
